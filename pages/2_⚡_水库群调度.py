...
def run_calculation_from_xlsx(uploaded_file, calc_step: str = "旬") -> bytes:
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        # 读取输出列名
        output_list_file = Path(__file__).resolve().parent.parent / "src" / "reservoir" / "output_columns.csv"
...
with st.sidebar:
    ...
    if uploaded_file:
        ...
        # 提供示例文件下载
        sample_xlsx = Path(__file__).resolve().parent.parent / "data" / "reservoir" / "sample" / "输入.xlsx"
